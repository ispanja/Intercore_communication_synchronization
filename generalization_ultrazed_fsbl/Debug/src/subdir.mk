...
C_SRCS += \
/home/ivan/diplomski/ultrazed_hw_platform/psu_init.c \
...
src/psu_init.o: /home/ivan/diplomski/ultrazed_hw_platform/psu_init.c
	@echo 'Building file: $<'
	@echo 'Invoking: ARM A53 gcc compiler'
	aarch64-none-elf-gcc -DARMA53_64 -D FSBL_DEBUG_INFO -Wall -O0 -g3 -I"/home/ivan/diplomski/ultrazed_hw_platform" -c -fmessage-length=0 -MT"$@" -Os -flto -ffat-lto-objects -I../../generalization_ultrazed_fsbl_bsp/psu_cortexa53_0/include -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
