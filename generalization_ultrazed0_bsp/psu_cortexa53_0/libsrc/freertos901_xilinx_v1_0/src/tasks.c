...
#endif /* config_USE_EDF_SCHEDULER */
/*-----------------------------------------------------------*/
//This task is OK
/*
...
typedef struct tskTaskControlBlock
{
	...
	//Added deadline (period) parameter
...
//Added macro for EDF scheduler
#if ( configUSE_EDF_SCHEDULER == 1 )

PRIVILEGED_DATA static List_t xReadyTasksListEDF; /*< Deadline ready tasks EDF. */
...
//Added function for creating EDF tasks
...
BaseType_t xReturn;
	...
	#else
	{
			...
			xReturn = xTaskEdfCreate( prvIdleTask, "IDLE", configMINIMAL_STACK_SIZE, (void * ) NULL, ( tskIDLE_PRIORITY | portPRIVILEGE_BIT ), NULL, initIDLEPeriod );
		#endif /* configUSE_EDF_SCHEDULER */
	}
	#endif /* configSUPPORT_STATIC_ALLOCATION */
...
#else
						//Priority according to deadline
